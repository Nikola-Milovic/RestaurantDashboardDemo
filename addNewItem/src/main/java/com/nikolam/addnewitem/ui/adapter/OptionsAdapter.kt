package com.nikolam.addnewitem.ui.adapter
...
import com.nikolam.addnewitem.databinding.OptionsItemAddnewBinding
import com.nikolam.core.model.Price
import com.nikolam.core.utils.bindings


class OptionsAdapter() :
    RecyclerView.Adapter<OptionsAdapter.OptionsViewHolder>(), DataChangeListener {

    private var prices: ArrayList<Price> = arrayListOf(Price("Promeni", 0))
    ...
    override fun onCreateViewHolder(
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.options_item_addnew, parent, false)
        return OptionsViewHolder(view, this)
    }

    // Replace the contents of a view (invoked by the layout manager)
    override fun onBindViewHolder(holderDetail: OptionsViewHolder, position: Int) {
    ...
    inner class OptionsViewHolder(val view: View, val listener: DataChangeListener) :
        RecyclerView.ViewHolder(view) {

        private lateinit var data: Price
        private val binding: OptionsItemAddnewBinding by bindings(view)
